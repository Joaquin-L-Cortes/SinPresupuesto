...
(function () {
  ...
  // ── CONFIGURACIÓN ─────────────────────────────────
  const GEMINI_KEY = 'AIzaSyCL71C-uAb6ZLwU8dguFShA6SO8O6YSZaU'; // ← Pega aquí tu API key de Google AI Studio
  ...
  // ═══════════════════════════════════════════════════════════════
  //  CATÁLOGO SEMÁNTICO v2 — temas, subtemas y sinónimos
  // ═══════════════════════════════════════════════════════════════
  const TOPIC_MAP = [
    { tema: 'Lectura Crítica', keywords: ['lectura','critica','comprension','texto','textual','inferencia','coherencia','cohesion','argumentacion','tipologia','pragmatica','discurso','leer','lectura critica'] },
    { tema: 'Matemáticas', keywords: ['matematica','algebra','ecuacion','sistema','geometria','trigonometria','estadistica','probabilidad','funcion','calculo','diferencial','combinatoria','logica','vector','matriz','complejo','sucesion','serie','aritmetica','numero','razonamiento abstracto'] },
    { tema: 'Álgebra', keywords: ['algebra','ecuacion','inecuacion','sistema','polinomio','factorizacion','logaritmo','exponencial'] },
    { tema: 'Geometría', keywords: ['geometria','triangulo','circulo','angulo','area','perimetro','volumen','pitagoras','plano','espacio','analitica','conica'] },
    { tema: 'Trigonometría', keywords: ['trigonometria','seno','coseno','tangente','identidad trigonometrica'] },
    { tema: 'Cálculo', keywords: ['calculo','derivada','limite','derivacion'] },
    { tema: 'Estadística', keywords: ['estadistica','probabilidad','media','mediana','moda','distribucion','varianza'] },
    { tema: 'Física', keywords: ['fisica','fuerza','movimiento','energia','trabajo','potencia','newton','cinematica','dinamica','fluido','termodinamica','optica','onda','electricidad','magnetismo','circuito','nuclear','moderna','relatividad','cuantica','calor','temperatura','velocidad','aceleracion'] },
    { tema: 'Cinemática', keywords: ['cinematica','movimiento','velocidad','aceleracion','mrua','mru','caida libre','tiro parabolico'] },
    { tema: 'Termodinámica', keywords: ['termodinamica','temperatura','calor','gas','presion','entropia'] },
    { tema: 'Electricidad', keywords: ['electricidad','circuito','corriente','voltaje','resistencia','ohm','capacitor'] },
    { tema: 'Biología', keywords: ['biologia','celula','gen','genetica','herencia','ecologia','ecosistema','evolucion','seleccion natural','fisiologia','metabolismo','nervioso','reproduccion','taxonomia','adn','arn','mitosis','meiosis'] },
    { tema: 'Genética', keywords: ['genetica','herencia','gen','adn','arn','cromosoma','mutacion','alelo','mendel'] },
    { tema: 'Ecología', keywords: ['ecologia','ecosistema','bioma','biodiversidad','cadena alimentaria','habitat','poblacion'] },
    { tema: 'Evolución', keywords: ['evolucion','darwin','seleccion natural','adaptacion','especiacion'] },
    { tema: 'Química', keywords: ['quimica','tabla periodica','enlace','reaccion','estequiometria','solucion','concentracion','equilibrio','organica','acido','base','electroquimica','oxido','sal','nomenclatura'] },
    { tema: 'Química Orgánica', keywords: ['organica','hidrocarburo','alcohol','cetona','aldehido','acido carboxilico','polimero'] },
    { tema: 'Ciencias Sociales', keywords: ['sociales','historia','geografia','politica','economia','constitucion','filosofia','etica','sociologia','cultura','ciudadania','democracia','colombia','universal','territorio','geopolitica'] },
    { tema: 'Historia de Colombia', keywords: ['historia colombia','independencia','colonial','violencia','frente nacional','bogotazo','virreinato','conquista'] },
    { tema: 'Historia Universal', keywords: ['historia universal','grecia','roma','edad media','renacimiento','revolucion francesa','guerra fria','imperialismo'] },
    { tema: 'Geografía', keywords: ['geografia','territorio','mapa','bioma','clima','relieve','hidrografia','region','continente'] },
    { tema: 'Filosofía', keywords: ['filosofia','etica','moral','epistemologia','metafisica','socrates','platon','aristoteles','kant','razonamiento'] },
    { tema: 'Economía', keywords: ['economia','mercado','oferta','demanda','inflacion','pib','empresa','banco','impuesto','capitalismo'] },
    { tema: 'Constitución', keywords: ['constitucion','derechos','deberes','ciudadania','estado','gobierno','congreso','democracia','ley','decreto'] },
    { tema: 'Análisis de Imagen', keywords: ['imagen','fotografia','cine','arte','pintura','semiotica','visual','composicion','encuadre','publicidad','retorica','propaganda','caricatura','documental','icono','signo','simbolo','montaje','infografia'] },
    { tema: 'Examen UNAL', keywords: ['unal','examen unal','admision','puntaje','prueba admision','universidad nacional','icfes','saber 11','simulacro'] },
    { tema: 'Matrícula Cero', keywords: ['matricula cero','gratuidad','beca','beneficio','gratuidad educacion'] },
    { tema: 'UdeA', keywords: ['udea','universidad antioquia','comprension lectora udea','razonamiento logico udea'] },
    { tema: 'Simulacro', keywords: ['simulacro','prueba','cuadernillo','tipo icfes','tipo unal'] },
    { tema: 'Video / YouTube', keywords: ['video','youtube','clase','clase grabada','clases','explicacion','ver clase','canal'] },
    { tema: 'App', keywords: ['app','aplicacion','android','apk','movil','celular'] },
    { tema: 'Temario', keywords: ['temario','programa','que sale','que entra','temas unal','temas icfes'] },
  ];

  const SYNONYM_MAP = {
    'mate': 'Matemáticas', 'mates': 'Matemáticas', 'maths': 'Matemáticas',
    'algebra lineal': 'Álgebra', 'ecuaciones': 'Álgebra',
    'geo': 'Geometría', 'geometria analitica': 'Geometría',
    'trig': 'Trigonometría', 'trigo': 'Trigonometría',
    'calculo diferencial': 'Cálculo', 'derivadas': 'Cálculo', 'limites': 'Cálculo',
    'proba': 'Estadística', 'probabilidades': 'Estadística',
    'fis': 'Física', 'fisics': 'Física',
    'cine': 'Cinemática', 'mrua': 'Cinemática',
    'termo': 'Termodinámica', 'calor': 'Termodinámica',
    'electro': 'Electricidad', 'circuito electrico': 'Electricidad',
    'optica': 'Física', 'ondas': 'Física', 'sonido': 'Física',
    'bio': 'Biología', 'biol': 'Biología',
    'celula': 'Biología', 'dna': 'Genética', 'adn': 'Genética',
    'mendel': 'Genética', 'meiosis': 'Genética', 'mitosis': 'Biología',
    'darwin': 'Evolución', 'adaptacion': 'Evolución',
    'biodiversidad': 'Ecología', 'ecosistema': 'Ecología',
    'quim': 'Química', 'quimica organica': 'Química Orgánica',
    'tabla periodica': 'Química', 'acido': 'Química', 'mol': 'Química',
    'estequio': 'Química',
    'sociales': 'Ciencias Sociales', 'soc': 'Ciencias Sociales',
    'historia col': 'Historia de Colombia', 'hist col': 'Historia de Colombia',
    'historia uni': 'Historia Universal', 'hist uni': 'Historia Universal',
    'filo': 'Filosofía', 'etica': 'Filosofía',
    'economia': 'Economía', 'micro': 'Economía', 'macro': 'Economía',
    'ciudadania': 'Constitución',
    'imagen': 'Análisis de Imagen', 'img': 'Análisis de Imagen',
    'foto': 'Análisis de Imagen', 'semiotica': 'Análisis de Imagen', 'arte': 'Análisis de Imagen',
    'lectura': 'Lectura Crítica', 'comprension': 'Lectura Crítica',
    'textos': 'Lectura Crítica', 'argumentacion': 'Lectura Crítica',
    'examen': 'Examen UNAL', 'icfes': 'Examen UNAL',
    'admision': 'Examen UNAL', 'puntaje': 'Examen UNAL',
    'saber11': 'Examen UNAL', 'saber 11': 'Examen UNAL',
    'video': 'Video / YouTube', 'clase': 'Video / YouTube', 'clases': 'Video / YouTube',
    'apk': 'App', 'aplicacion': 'App',
    'diapositivas': 'Diapositiva',
    'tomo': 'Tomo', 'tomos': 'Tomo',
    'temario': 'Temario', 'programa': 'Temario',
  };

  const SECTION_TOPICS = {
    'Módulos Teóricos':          ['Matemáticas','Física','Biología','Química','Ciencias Sociales','Análisis de Imagen','Lectura Crítica'],
    'Ejercicios y Prácticas':    ['Matemáticas','Física','Biología','Química','Ciencias Sociales','Análisis de Imagen','Lectura Crítica','Simulacro'],
    'Apuntes de Estudio':        ['Matemáticas','Ciencias Sociales','Análisis de Imagen'],
    'Diapositivas':              ['Física','Ciencias Sociales'],
    'Textos y Práctica Textual': ['Lectura Crítica'],
    'Simulacros UN':             ['Simulacro','Examen UNAL'],
    'Módulos Especiales':        ['Simulacro','Examen UNAL'],
    'Admisión y Exámenes UN':    ['Examen UNAL','Matrícula Cero'],
    'Recursos UdeA':             ['UdeA','Lectura Crítica'],
    'Relámpago 2026':            ['Matemáticas','Física','Biología'],
    'Tomos':                     ['Matemáticas','Física','Biología'],
    'Temarios':                  ['Temario'],
    'Apps Android':              ['App'],
    'Clases PreU':               ['Video / YouTube'],
  };
  ...
  function detectTopics(query) {
    ...
    for (const key of synKeys) {
      if (q.includes(key)) found.add(SYNONYM_MAP[key]);
    }
    for (const entry of TOPIC_MAP) {
      let matched = 0;
      for (const kw of entry.keywords) {
        if (q.includes(kw)) { matched++; break; }
        for (const w of words) {
          if (w.length > 3 && kw.startsWith(w)) { matched++; break; }
        }
      }
      if (matched > 0) found.add(entry.tema);
    }
    return [...found];
  }
  ...
  function smartSearch(query, maxResults) {
    ...
    return CATALOG.map(function(f, i) {
      const name = normalize(f.n);
      const sect = normalize(f.s);
      let score = 0;
      for (const w of qWords) {
        if (name.includes(w)) score += 4;
        else if (name.split(' ').some(function(t) { return t.startsWith(w); })) score += 2;
        if (sect.includes(w)) score += 1;
      }
      if (qWords.some(function(w) { return name.startsWith(w); })) score += 2;
      if (detectedTopics.length > 0) {
        const sectionTopics = SECTION_TOPICS[f.s] || [];
        const topicOverlap = detectedTopics.filter(function(t) { return sectionTopics.includes(t); }).length;
        score += topicOverlap * 3;
        for (const topic of detectedTopics) {
          const entry = TOPIC_MAP.find(function(e) { return e.tema === topic; });
          if (entry) {
            for (const kw of entry.keywords) {
              if (name.includes(normalize(kw))) { score += 2; break; }
            }
          }
        }
      }
  ...
  function localSearch(query, maxResults) {
    return smartSearch(query, maxResults);
  }
